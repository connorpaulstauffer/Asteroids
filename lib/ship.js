(function() {
  ...
  Ship.prototype.stopAccelerating = function () {
    ...
    // if (this.decelerateInterval) { return; }
    //
    // this.decelerateInterval = setInterval(function () {
    //   if (Math.abs(this.vel[0]) < 0.1) {
    //     this.vel[0] = 0;
    //   } else {
    //     if (this.vel[0] > 0) {
    ...
    //     return;
    //   }
    //   var ratio = Math.abs(this.vel[0] / this.vel[1]);
    //   var b = 1 / Math.sqrt(Math.pow(ratio, 2) + 1);
    //   var a = b * ratio;
    //   a = a / 10;
    //   b = b / 10;
    //
    //   if (a > Math.abs(this.vel[0])) {
    //     this.vel[0] = 0
    //   } else {
    //     if (this.vel[0] > 0) {
    //       this.vel[0] -= a;
